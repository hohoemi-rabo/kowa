...
function initFacilityGallery() {
    ...
    hallCards.forEach(card => {
        ...
        const expandBtn = card.querySelector('.hall-card__expand');
        ...
        thumbnails.forEach(thumb => {
            thumb.addEventListener('click', function() {
                ...
                // メイン画像の切り替え（実際の実装では画像URLを変更）
                // const imageId = this.dataset.image;
                // mainImage.src = getImageUrl(imageId);
...
function openLightbox(imageSrc, imageAlt) {
    ...
    lightbox.innerHTML = `
        ...
        <div class="lightbox__content">
            ...
            <img src="${imageSrc}" alt="${imageAlt}" class="lightbox__image">
        </div>
    `;
