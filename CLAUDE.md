...
- 施設案内: 画像準備中（プレースホルダー表示、元のギャラリーコードはHTMLコメントで保持）
...
- おすすめPOINT 3: アイコン `fa-book-open`（無料版対応）
...
- スタッフ紹介: 削除済み
- 会社名: 株式会社光和
- 電話番号: フリーダイヤルアイコン（緑丸、左右反転）+ TEL. 0265-53-2111
- 所在地: `<address>`タグにfont-style: normal適用
...
2. **電話番号:** フリーダイヤル `0120-077-508`、TEL `0265-53-2111`
3. **住所情報:** `〒395-0821 長野県飯田市松尾新井6544-1`
4. **フォーム送信:** Contact Form 7 を使用（page-contact.php実装済み）、その他のフォームは独自実装が必要
5. **プレースホルダー画像:** 本番前に実画像に差し替え（plan-card\_\_image--placeholder、hall-card\_\_gallery--placeholder クラスを削除）
6. **施設ギャラリー画像:** 画像準備中。元のギャラリーコードはHTMLコメントで保持（TODOコメント参照）
7. **宿泊可能:** 通夜室・仮眠室完備、バスルーム・パウダールーム・キッチンあり
8. **Copyright:** `© 2026 株式会社光和`
